...
# -*- coding: utf-8 -*-
"""
etymology.py - Lookup Etymologies
...
def f_etymology(self, origin, args): 
   word = args.params
...
f_etymology.rule = ['ety', 'etymology']
f_etymology.thread = True
f_etymology.showas= "ety(mology)"
